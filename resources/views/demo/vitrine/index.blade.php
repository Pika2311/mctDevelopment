...
<head>
	...
	<link rel="apple-touch-icon" href="{{ url('assets/vitrine/apple-touch-icon.png') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/bootstrap.min.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/normalize.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/font-awesome.min.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/transitions.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/prettyPhoto.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/swiper.min.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/jquery-ui.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/animate.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/owl.theme.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/owl.carousel.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/customScrollbar.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/icomoon.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/main.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/color.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vitrine/css/responsive.css') }}">
	<script src="{{ url('assets/vitrine/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js') }}"></script>
</head>
<body>
	<!--[if lt IE 8]>
				...
				<ul>
					<li class="active menu-item-has-children">
						...
						<ul class="tg-dropdown-menu">
							<li class="active"><a href="{{ url('assets/vitrine/index-2.html') }}">home1</a></li>
							<li><a href="{{ url('assets/vitrine/index2.html') }}">home2</a></li>
						</ul>
					</li>
					<li class="menu-item-has-children">
						<a href="#">team</a>
						<ul class="tg-dropdown-menu">
							<li><a href="{{ url('assets/vitrine/playergrid-v1.html') }}">playergrid-v1</a></li>
							<li><a href="{{ url('assets/vitrine/playergrid-v2.html') }}">playergrid-v2</a></li>
							<li><a href="{{ url('assets/vitrine/playerdetail.html') }}">playergrid detail</a></li>
						</ul>
					</li>
					<li><a href="{{ url('assets/vitrine/buyticket.html') }}">Buy Tickets</a></li>
					<li class="menu-item-has-children">
						<a href="#">Match Results</a>
						<ul class="tg-dropdown-menu">
							<li><a href="{{ url('assets/vitrine/matchresult.html') }}">match result</a></li>
							<li><a href="{{ url('assets/vitrine/matchresultdetail.html') }}">match result detail</a></li>
						</ul>
					</li>
				</ul>
			</div>
			<div class="tg-colhalf">
				<ul>
					<li class="menu-item-has-children">
						<a href="#">fixtures</a>
						<ul class="tg-dropdown-menu">
							<li><a href="{{ url('assets/vitrine/fixtures.html') }}">fixtures</a></li>
							<li><a href="{{ url('assets/vitrine/fixturedetail.html') }}">fixture detail</a></li>
						</ul>
					</li>
					<li class="menu-item-has-children">
						<a href="#">pro soccer media</a>
						<ul class="tg-dropdown-menu">
							<li><a href="{{ url('assets/vitrine/soccermedia-1.html') }}">pro soccer media1</a></li>
							<li><a href="{{ url('assets/vitrine/soccermedia-2.html') }}">pro soccer media2</a></li>
						</ul>
					</li>
					<li><a href="{{ url('assets/vitrine/contactus.html') }}">Contact</a></li>
					<li class="menu-item-has-children">
						<a href="#"><i class=" fa fa-navicon"></i></a>
						<ul>
							<li><a href="{{ url('assets/vitrine/aboutus.html') }}">about us</a></li>
							<li><a href="{{ url('assets/vitrine/shoplist.html') }}">shop list</a></li>
							<li><a href="{{ url('assets/vitrine/shopgrid.html') }}">shop grid</a></li>
							<li><a href="{{ url('assets/vitrine/productsingle.html') }}">shop detail</a></li>
							<li><a href="{{ url('assets/vitrine/bloglist.html') }}">blog list</a></li>
							<li><a href="{{ url('assets/vitrine/bloggrid.html') }}">blog grid</a></li>
							<li><a href="{{ url('assets/vitrine/blogdetail.html') }}">blog detail</a></li>
							<li><a href="{{ url('assets/vitrine/404.html') }}">404 error</a></li>
							<li><a href="{{ url('assets/vitrine/comming-soon.html') }}">comming soon</a></li>
						</ul>
					</li>
				</ul>
			</div>
							...
							<nav id="tg-topaddnav" class="tg-topaddnav">
								...
								<div id="tg-addnavigationm-mobile" class="tg-addnavigationm-mobile collapse navbar-collapse">
									<div class="tg-colhalf pull-right">
										<nav class="tg-addnav">
											<ul>
												<li><a href="{{ url('assets/vitrine/javascript().html') }}" data-toggle="modal" data-target="#tg-login">login</a></li>
												<li><a href="{{ url('assets/vitrine/javascript().html') }}" data-toggle="modal" data-target="#tg-register">Register</a></li>
												<li>
													<div class="tg-cart">
														<a href="{{ url('assets/vitrine/javascript:void(0)') }}" class="dropdown-toggle" id="tg-cartdropdown" data-toggle="dropdown">
														...
														<div class="tg-cartcontent dropdown-menu" aria-labelledby="tg-cartdropdown">
															<ul>
																<li>
																	<figure>
																		<a href="#">
																			<img src="{{ url('assets/vitrine/images/thumbnails/img-01.jpg') }}" alt="image description">
																		</a>
																	</figure>
																...
																<li>
																	<figure>
																		<a href="#">
																			<img src="{{ url('assets/vitrine/images/thumbnails/img-02.jpg') }}" alt="image description">
																		</a>
																	</figure>
																	<div class="tg-product-detail">
																		<h3><a href="#">Smooth 3-Stripes Scarf</a></h3>
																...
																<li>
																	<figure>
																		<a href="#">
																			<img src="{{ url('assets/vitrine/images/thumbnails/img-03.jpg') }}" alt="image description">
																		</a>
																	</figure>
																	<div class="tg-product-detail">
																		<h3><a href="#">Smooth 3-Stripes Scarf</a></h3>
												...
												<li>
													<a id="tg-btn-search" href="{{ url('assets/vitrine/javascript:void(0)') }}"><i class="fa fa-search"></i></a>
												</li>
											</ul>
										</nav>
									</div>
						...
						<nav id="tg-nav" class="tg-nav brand-center">
							<div class="navbar-header">
								...
								<strong class="tg-logo">
									<a href="{{ url('assets/vitrine/index-2.html') }}"><img src="{{ url('assets/vitrine/images/logo.png') }}" alt="image description"></a>
								</strong>
							</div>
		...
		*************************************-->
		<div class="tg-sliderbox">
			<div class="tg-imglayer">
				<img src="{{ url('assets/vitrine/images/bg-pattran.png') }}" alt="image desctription">
			</div>
					...
					<div class="swiper-slide">
						<div class="container">
							<figure class="floating">
								<img src="{{ url('assets/vitrine/images/slider/img-01.png') }}" alt="image description">
							</figure>
		...
		<main id="tg-main" class="tg-main tg-haslayout">
							...
							<div class="tg-aboutussection">
								<div class="row">
									<div class="col-md-6 col-sm-12 col-xs-12">
										<figure>
											<img src="{{ url('assets/vitrine/images/img-01.jpg') }}" alt="image description">
										</figure>
									</div>
									<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<div class="row">
							<div class="tg-upcomingmatch-counter">
								<div class="col-md-4 col-sm-4 col-xs-12 hidden-xs">
									<figure>
										<img src="{{ url('assets/vitrine/images/img-02.png') }}" alt="image description">
									</figure>
								</div>
													...
													<div class="tg-box">
														...
														<div class="tg-teamscore">
															<strong class="tg-team-logo">
																<a href="#">
																	<img src="{{ url('assets/vitrine/images/team-logo/logo-01.png') }}" alt="image description">
																</a>
															</strong>
														...
														<div class="tg-teamscore">
															<strong class="tg-team-logo">
																<a href="#">
																	<img src="{{ url('assets/vitrine/images/team-logo/logo-02.png') }}" alt="image description">
																</a>
															</strong>
															<div class="tg-team-nameplusstatus">
														...
														<div class="tg-match">
															<div class="tg-box">
																<strong class="tg-teamlogo">
																	<img src="{{ url('assets/vitrine/images/team-logo/logo-s-01.png') }}" alt="image description">
																</strong>
																<h4>win</h4>
															</div>
															<div class="tg-box">
												...
												<div class="swiper-slide">
													<div class="tg-match">
														<div class="tg-matchdetail">
															<div class="tg-box">
																<strong class="tg-teamlogo">
																	<img src="{{ url('assets/vitrine/images/team-logo/logo-l-02.png') }}" alt="image description">
																</strong>
																<h3>Gladiators</h3>
															</div>
															<div class="tg-box">
			...
			*************************************-->
			<section class="tg-videobox tg-haslayout">
				<figure>
					<img src="{{ url('assets/vitrine/images/bg-video.jpg') }}" alt="image description">
					<figcaption>
										...
										<div id="tg-playerscrollbar" class="tg-players tg-playerscrollbar">
											<div class="tg-player">
												...
												<div class="col-sm-6 col-xs-6">
													<figure>
														<a href="#">
															<img src="{{ url('assets/vitrine/images/player/img-01.png') }}" alt="image description">
														</a>
													</figure>
												</div>
											</div>
											<div class="tg-player">
												...
												<div class="col-sm-6 col-xs-6">
													<figure>
														<a href="#">
															<img src="{{ url('assets/vitrine/images/player/img-02.png') }}" alt="image description">
														</a>
													</figure>
												</div>
											</div>
											<div class="tg-player">
												...
												<div class="col-sm-6 col-xs-6">
													<figure>
														<a href="#">
															<img src="{{ url('assets/vitrine/images/player/img-03.png') }}" alt="image description">
														</a>
													</figure>
												</div>
											</div>
						...
						<div class="row">
							<div class="tg-pointstablewrapper">
								...
								<div class="col-sm-4 col-xs-12 hidden-xs">
									<figure>
										<img src="{{ url('assets/vitrine/images/img-03.png') }}" alt="image description">
									</figure>
								</div>
							</div>
						</div>
								...
								<div class="row">
									<div class="col-sm-6 col-xs-12">
										<article class="tg-post">
											<figure class="tg-postimg">
												<a href="#">
													<img src="{{ url('assets/vitrine/images/blog/img-01.jpg') }}" alt="image description">
												</a>
												<figcaption>
									...
									<div class="col-sm-6 col-xs-12">
										<article class="tg-post">
											<figure class="tg-postimg">
												<a href="#">
													<img src="{{ url('assets/vitrine/images/blog/img-02.jpg') }}" alt="image description">
												</a>
												<figcaption>
													<ul class="tg-postmetadata">
														<li><a href="#">by admin</a></li>
									...
									<div class="tg-toprated">
										<ul>
											<li>
												<figure>
													<a href="#">
														<img src="{{ url('assets/vitrine/images/thumbnails/img-04.jpg') }}" alt="image description">
													</a>
												</figure>
											...
											<li>
												<figure>
													<a href="#">
														<img src="{{ url('assets/vitrine/images/thumbnails/img-05.jpg') }}" alt="image description">
													</a>
												</figure>
												<div class="tg-productcontent">
													<h4><a href="#">Smooth 3-Stripes Scarf</a></h4><span class="tg-stars"><span></span></span>
											...
											<li>
												<figure>
													<a href="#">
														<img src="{{ url('assets/vitrine/images/thumbnails/img-06.jpg') }}" alt="image description">
													</a>
												</figure>
												<div class="tg-productcontent">
													<h4><a href="#">Smooth 3-Stripes Scarf</a></h4><span class="tg-stars"><span></span></span>
											...
											<li>
												<figure>
													<a href="#">
														<img src="{{ url('assets/vitrine/images/thumbnails/img-07.jpg') }}" alt="image description">
													</a>
												</figure>
												<div class="tg-productcontent">
													<h4><a href="#">Smooth 3-Stripes Scarf</a></h4><span class="tg-stars"><span></span></span>
							...
							<div class="col-sm-4">
								<div class="tg-footercol">
									<div class="tg-haslayout">
										<strong class="tg-logo">
											<a href="#">
												<img src="{{ url('assets/vitrine/images/logo2.png') }}" alt="image description">
											</a>
										</strong>
									</div>
									<div class="tg-description">
									...
									<ul class="tg-contactinfo">
										...
										<li>
											...
											<a href="{{ url('assets/vitrine/info%40domain.html') }}">info@domain.com</a>
										</li>
										<li>
	...
	*************************************-->
	<div class="tg-searchbox">
		<a id="tg-close-search" class="tg-close-search" href="{{ url('assets/vitrine/javascript:void(0)') }}"><span class="fa fa-close"></span></a>
	...
	*************************************-->
	...
	<!--************************************
		LightBoxes End
	*************************************-->
	<script src="{{ url('assets/vitrine/js/vendor/jquery-library.js') }}"></script>
	<script src="{{ url('assets/vitrine/js/vendor/bootstrap.min.js') }}"></script>
	<script src="{{ url('assets/vitrine/js/customScrollbar.min.js') }}"></script>
	<script src="{{ url('assets/vitrine/js/owl.carousel.js') }}"></script>
	<script src="{{ url('assets/vitrine/js/isotope.pkgd.js') }}"></script>
	<script src="{{ url('assets/vitrine/js/prettyPhoto.js') }}"></script>
	<script src="{{ url('assets/vitrine/js/swiper.min.js') }}"></script>
	<script src="{{ url('assets/vitrine/js/jquery-ui.js') }}"></script>
	<script src="{{ url('assets/vitrine/js/countTo.js') }}"></script>
	<script src="{{ url('assets/vitrine/js/appear.js') }}"></script>
	<script src="{{ url('assets/vitrine/js/main.js') }}"></script>
</body>
